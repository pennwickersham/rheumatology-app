...
export default function Medications() {
  ...
  const toggleSection = (key) => {
    const opening = !expandedSections[key];
    setExpandedSections(prev => ({ ...prev, [key]: !prev[key] }));
    // When opening a section, align its header to the top of the scroll
    // area so the reader starts at the beginning of the text.
    if (opening) {
      requestAnimationFrame(() => {
        const el = document.getElementById(`fda-section-${key}`);
